...
class MapAggregatingIteratorTest extends Specification with TestWithDataStore {
  ...
  override def spec = "id:Integer,map:Map[String,Integer],dtg:Date,geom:Geometry:srid=4326"
...
class MapAggregatingIteratorDoubleTest extends Specification with TestWithDataStore {
  ...
  override val spec = "id:Integer,map:Map[Double,Integer],dtg:Date,geom:Geometry:srid=4326"
